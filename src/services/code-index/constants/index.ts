...
/**Reranking */
export const DEFAULT_RERANKING_ENABLED = CODEBASE_INDEX_DEFAULTS.DEFAULT_RERANKING_ENABLED
export const DEFAULT_RERANKING_TOP_K = CODEBASE_INDEX_DEFAULTS.DEFAULT_RERANKING_TOP_K
export const DEFAULT_RERANKING_INITIAL_RESULTS = CODEBASE_INDEX_DEFAULTS.DEFAULT_RERANKING_INITIAL_RESULTS
...
/**Ollama Embedder */
export const OLLAMA_DEFAULT_CONTEXT_SIZE = 32768 // Safe default for most embedding models
export const OLLAMA_MAX_BATCH_TOKENS = 16384 // Conservative batch size for Ollama to avoid context issues
